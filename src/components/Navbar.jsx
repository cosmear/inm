        ...
        <header className="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-cream/80 backdrop-blur-md border-b border-primary/10">
            <div className="max-w-[1440px] mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
                ...
                <nav className="flex items-center gap-6 md:gap-10">
                    <Link href="/search?operation=Comprar" className="text-xs font-semibold text-stone-dark hover:text-primary uppercase tracking-wider transition-colors">Comprar</Link>
                    <Link href="/search?operation=Alquilar" className="text-xs font-semibold text-stone-dark hover:text-primary uppercase tracking-wider transition-colors">Alquilar</Link>
                    {token ? (
